...
const int GRIP_CLOSE = 900; //tested success

const int NECK_LEFT = 0; //tested success
const int NECK_RITE = 1000; //tested success

const int THIRD_LEFT = 850; //tested success
const int THIRD_RITE = 100; //tested success

const int FORTH_LEFT = 150; //tested success
const int FORTH_RITE = 900; //tested success

const int FIFTH_LEFT = 900; //tested success
const int FIFTH_RITE = 150; //tested success

const int BOTTOM_LEFT = 160; //tested success
const int BOTTOM_RITE = 940; //tested success
...
void stop_servos() {
  ...
  myse.moveServo(FORTH, 500, exec_dely);    delay(norm_dely);
